...
def handle_options():
    try:
        ...
        current_app.logger.error(f"Error handling OPTIONS request: {e}")
...
def verify_jwt_token():
    try:
        ...
        current_app.logger.error(f"Error verifying JWT token: {e}")
        return jsonify({"error": "An unexpected error occurred while verifying the token"}), 500
...
def create_todo():
    try:
        ...
        current_app.logger.error(f"Error creating To-Do: {e}")
        return jsonify({"error": "An unexpected error occurred while creating the To-Do"}), 500
...
def get_todos(user_id):
    try:
        ...
        current_app.logger.error(f"Error retrieving To-Dos: {e}")
        return jsonify({"error": "An unexpected error occurred while retrieving To-Dos"}), 500
...
def get_todo_by_id(todo_id):
    try:
        ...
        current_app.logger.error(f"Error retrieving To-Do by ID: {e}")
        return jsonify({"error": "An unexpected error occurred while retrieving the To-Do"}), 500
...
def toggle_completed(todo_id):
    try:
        ...
        current_app.logger.error(f"Error toggling To-Do completed state: {e}")
        return jsonify({"error": "An unexpected error occurred while toggling the To-Do"}), 500
...
def update_todo(todo_id):
    try:
        ...
        current_app.logger.error(f"Error updating To-Do: {e}")
        return jsonify({"error": "An unexpected error occurred while updating the To-Do"}), 500
...
def delete_todo(todo_id):
    try:
        ...
        current_app.logger.error(f"Error deleting To-Do: {e}")
        return jsonify({"error": "An unexpected error occurred while deleting the To-Do"}), 500
